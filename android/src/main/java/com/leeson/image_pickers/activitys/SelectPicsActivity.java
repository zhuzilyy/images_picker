...
public class SelectPicsActivity extends BaseActivity {
    ...
    private void startSel() {
        ...
        if (mimeType != null) {
            ...
            int language = 2;
            if(compressSize.intValue() == 101){
                language = LanguageConfig.ENGLISH;
            }else if(compressSize.intValue() == 102){
                language = LanguageConfig.TH;
            }else if(compressSize.intValue() == 103){
                language = LanguageConfig.CHINESE;
            }else if(compressSize.intValue() == 104){
